...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ \"moment\");\n/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var uuid_v4__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! uuid/v4 */ \"./node_modules/uuid/v4.js\");\n/* harmony import */ var uuid_v4__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(uuid_v4__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _helpers_Helper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../helpers/Helper */ \"./helpers/Helper.js\");\n\r\n\r\n\r\n\r\nclass User {\r\n    constructor(data) {\r\n        this._id = uuid_v4__WEBPACK_IMPORTED_MODULE_1___default()();\r\n        this._name = data.name;\r\n        this._surname = data.surname;\r\n        this._email = data.email;\r\n        this._password = _helpers_Helper__WEBPACK_IMPORTED_MODULE_2__[\"default\"].hashPassword(data.password);\r\n        this._created_date = moment__WEBPACK_IMPORTED_MODULE_0___default()(new Date());\r\n        this._modified_date = moment__WEBPACK_IMPORTED_MODULE_0___default()(new Date());\r\n    }\r\n\r\n    get id() {\r\n        return this._id;\r\n    }\r\n\r\n    get name() {\r\n        return this._name;\r\n    }\r\n\r\n    get surname() {\r\n        return this._surname;\r\n    }\r\n\r\n    get email() {\r\n        return this._email;\r\n    }\r\n\r\n    get password() {\r\n        return this._password;\r\n    }\r\n\r\n    get created_date() {\r\n        return this._created_date;\r\n    }\r\n\r\n    get modified_date() {\r\n        return this._modified_date;\r\n    }\r\n}\r\n\r\n/* harmony default export */ __webpack_exports__[\"default\"] = (User);\r\n\n\n//# sourceURL=webpack:///./api/v1/models/User.js?");

/***/ }),

/***/ "./api/v1/repository/CreditCardRepository.js":
/*!***************************************************!*\
  !*** ./api/v1/repository/CreditCardRepository.js ***!
  \***************************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _helpers_Helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../helpers/Helper */ \"./helpers/Helper.js\");\n/* harmony import */ var _repository_CreditCardRepository__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../repository/CreditCardRepository */ \"./api/v1/repository/CreditCardRepository.js\");\n/* harmony import */ var _models_CreditCard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/CreditCard */ \"./api/v1/models/CreditCard.js\");\n\r\n\r\n\r\n\r\nconst CreditCardService = {\r\n\r\n  async verify(req, res) {\r\n    try {\r\n      const { rows } = await _repository_CreditCardRepository__WEBPACK_IMPORTED_MODULE_1__[\"getCreditCard\"]('user_id', [req.body.user.id]);\r\n\r\n      if(!rows[0]) {\r\n        return res.status(400).send({ 'message': 'Your card is not connected' });\r\n      }\r\n      // const cardIsActive = Helper.isCreditCardActive(rows[0].credit_card_expiration_time);\r\n      // if (!cardIsActive) {\r\n      //   return res.status(400).send({'message': 'Credit card is not active'})\r\n      // }\r\n      return res.status(200).send();\r\n    }\r\n    catch (error) {\r\n      return res.status(400).send(error);\r\n    }\r\n  },\r\n\r\n  async create(req, res) {\r\n    const reqBody = req.body;\r\n    if (!reqBody.credit_card_number || !reqBody.credit_card_code || !reqBody.credit_card_cardholder_name) {\r\n      return res.status(400).send({'message': 'Some values are missing'});\r\n    }\r\n    try {\r\n      const {rows } = await _repository_CreditCardRepository__WEBPACK_IMPORTED_MODULE_1__[\"createCreditCard\"](new _models_CreditCard__WEBPACK_IMPORTED_MODULE_2__[\"default\"](reqBody));\r\n        return res.status(201).send();\r\n    }\r\n    catch (error) {\r\n      return res.status(400).send(error);\r\n    }\r\n  }\r\n\r\n}\r\n\r\n/* harmony default export */ __webpack_exports__[\"default\"] = (CreditCardService);\r\n\n\n//# sourceURL=webpack:///./api/v1/services/CreditCardService.js?");

/***/ }),

/***/ "./api/v1/services/TransactionHistoryService.js":
/*!******************************************************!*\
  !*** ./api/v1/services/TransactionHistoryService.js ***!
  \******************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _repository_TransactionHistoryRepository__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../repository/TransactionHistoryRepository */ \"./api/v1/repository/TransactionHistoryRepository.js\");\n/* harmony import */ var _models_TransactionHistory__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/TransactionHistory */ \"./api/v1/models/TransactionHistory.js\");\n/* harmony import */ var _repository_CreditCardRepository__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../repository/CreditCardRepository */ \"./api/v1/repository/CreditCardRepository.js\");\n\r\n\r\n\r\n\r\nconst TransactionHistoryService = {\r\n\r\n    async balance(req, res) {\r\n        try {\r\n            const { transactionHistory } = await _repository_TransactionHistoryRepository__WEBPACK_IMPORTED_MODULE_0__[\"getTransactionHistory\"]('user_id', [req.body.user.id])[0];\r\n            const { creditCard } = await _repository_CreditCardRepository__WEBPACK_IMPORTED_MODULE_2__[\"getCreditCard\"]('user_id', [req.body.user.id])[0];\r\n\r\n            if(!transactionHistory || !creditCard) {\r\n                return res.status(400).send({ 'message': 'You have no transaction history' });\r\n            }\r\n            const payedSum = transactionHistory.filter(transHis => transHis.sender_credit_card_number === creditCardNumber.creditCardNumber).reduce( (a, b) => {return a + b}, 0);\r\n            const recievedSum = transactionHistory.filter(transHis => transHis.sender_credit_card_number !== creditCardNumber.creditCardNumber).reduce( (a, b) => {return a + b}, 0);\r\n            return res.status(200).send({\r\n                payedSum,recievedSum\r\n            });\r\n        }\r\n        catch (error) {\r\n            return res.status(400).send(error);\r\n        }\r\n    },\r\n\r\n    async addTransaction(req, res) {\r\n        const reqBody = req.body;\r\n        if (!reqBody.sender_credit_card_number || !reqBody.receiver_credit_card_number || !reqBody.transcation_ammount) {\r\n            return res.status(400).send({'message': 'Some values are missing'});\r\n        }\r\n        try {\r\n            const { rows } = await _repository_TransactionHistoryRepository__WEBPACK_IMPORTED_MODULE_0__[\"createHistoryTransaction\"](new _models_TransactionHistory__WEBPACK_IMPORTED_MODULE_1__[\"default\"](reqBody));\r\n            return res.status(201).send(rows);\r\n        }\r\n        catch (error) {\r\n            return res.status(400).send(error);\r\n        }\r\n    }\r\n\r\n}\r\n\r\n/* harmony default export */ __webpack_exports__[\"default\"] = (TransactionHistoryService);\r\n\n\n//# sourceURL=webpack:///./api/v1/services/TransactionHistoryService.js?");

/***/ }),

/***/ "./api/v1/services/UserService.js":
/*!****************************************!*\
  !*** ./api/v1/services/UserService.js ***!
  \****************************************/
/*! exports provided: default */
